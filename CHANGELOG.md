...
- The nine operations that take a JSON body raise `ContentTooLargeError`
...
- Retry settings apply at client construction. Requests return immediately
  after their final attempt, and cancellation interrupts retry backoff.
