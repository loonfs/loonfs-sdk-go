...
func TestTrashListWithWireMock(
	t *testing.T,
) {
	...
	_, invocationErr := client.Trash.List(
		context.TODO(),
		request,
		option.WithHTTPHeader(
			http.Header{"X-Test-Id": []string{"TestTrashListWithWireMock"}},
		),
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "TestTrashListWithWireMock", "GET", "/v0/namespaces/namespace_id/filesystem/trash", nil, 1)
}
