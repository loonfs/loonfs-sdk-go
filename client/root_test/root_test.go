...
func TestCapabilitiesWithWireMock(
	t *testing.T,
) {
	...
	_, invocationErr := client.Capabilities(
		context.TODO(),
		option.WithHTTPHeader(
			http.Header{"X-Test-Id": []string{"TestCapabilitiesWithWireMock"}},
		),
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "TestCapabilitiesWithWireMock", "GET", "/v0/capabilities", nil, 1)
}
