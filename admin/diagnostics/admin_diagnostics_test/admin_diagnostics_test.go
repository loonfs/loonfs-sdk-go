...
package admin_diagnostics_test
...
func TestAdminDiagnosticsRetrieveWithWireMock(
	t *testing.T,
) {
	...
	_, invocationErr := client.Admin.Diagnostics.Retrieve(
		context.TODO(),
		request,
		option.WithHTTPHeader(
			http.Header{"X-Test-Id": []string{"TestAdminDiagnosticsRetrieveWithWireMock"}},
		),
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "TestAdminDiagnosticsRetrieveWithWireMock", "GET", "/v0/admin/namespaces/namespace_id/diagnostics", nil, 1)
}
