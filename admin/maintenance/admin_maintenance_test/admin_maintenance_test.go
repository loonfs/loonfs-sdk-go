...
package admin_maintenance_test
...
func TestAdminMaintenanceRunWithWireMock(
	t *testing.T,
) {
	...
	_, invocationErr := client.Admin.Maintenance.Run(
		context.TODO(),
		request,
		option.WithHTTPHeader(
			http.Header{"X-Test-Id": []string{"TestAdminMaintenanceRunWithWireMock"}},
		),
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "TestAdminMaintenanceRunWithWireMock", "POST", "/v0/admin/namespaces/namespace_id/maintenance/run", nil, 1)
}
