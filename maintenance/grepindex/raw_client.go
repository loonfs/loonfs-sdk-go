...
func (r *RawClient) Retrieve(
	...
	endpointURL := internal.EncodeURL(
		baseURL+"/v0/maintenance/namespaces/%v/grep/index",
		request.NamespaceID,
	)
...
func (r *RawClient) Disable(
	...
	endpointURL := internal.EncodeURL(
		baseURL+"/v0/maintenance/namespaces/%v/grep/index/disable",
		request.NamespaceID,
	)
	headers := internal.MergeHeaders(
		r.options.ToHeader(),
...
func (r *RawClient) Enable(
	...
	endpointURL := internal.EncodeURL(
		baseURL+"/v0/maintenance/namespaces/%v/grep/index/enable",
		request.NamespaceID,
	)
	headers := internal.MergeHeaders(
		r.options.ToHeader(),
...
func (r *RawClient) Gc(
	...
	endpointURL := internal.EncodeURL(
		baseURL+"/v0/maintenance/namespaces/%v/grep/index/gc",
		request.NamespaceID,
	)
	headers := internal.MergeHeaders(
		r.options.ToHeader(),
