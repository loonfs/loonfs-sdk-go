...
package maintenance_checkpoints_test
...
func TestMaintenanceCheckpointsListWithWireMock(
	t *testing.T,
) {
	...
	_, invocationErr := client.Maintenance.Checkpoints.List(
		context.TODO(),
		request,
		option.WithHTTPHeader(
			http.Header{"X-Test-Id": []string{"TestMaintenanceCheckpointsListWithWireMock"}},
		),
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "TestMaintenanceCheckpointsListWithWireMock", "GET", "/v0/maintenance/namespaces/namespace_id/checkpoints", nil, 1)
}

func TestMaintenanceCheckpointsCreateWithWireMock(
	t *testing.T,
) {
	WireMockBaseURL := os.Getenv("WIREMOCK_URL")
	if WireMockBaseURL == "" {
	...
	_, invocationErr := client.Maintenance.Checkpoints.Create(
		context.TODO(),
		request,
		option.WithHTTPHeader(
			http.Header{"X-Test-Id": []string{"TestMaintenanceCheckpointsCreateWithWireMock"}},
		),
	)
