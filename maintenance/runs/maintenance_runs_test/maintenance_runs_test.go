...
func TestMaintenanceRunsCreateWithWireMock(
	t *testing.T,
) {
	...
	_, invocationErr := client.Maintenance.Runs.Create(
		context.TODO(),
		request,
		option.WithHTTPHeader(
			http.Header{"X-Test-Id": []string{"TestMaintenanceRunsCreateWithWireMock"}},
		),
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "TestMaintenanceRunsCreateWithWireMock", "POST", "/v0/maintenance/namespaces/namespace_id/runs", nil, 1)
}
